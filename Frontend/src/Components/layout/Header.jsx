      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden md:block">
          <input
            type="text"
            placeholder="Search..."
            className="py-2 pl-10 pr-4 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-saffron focus:border-transparent dark:bg-gray-800 dark:text-white dark:border-gray-600"
          />
        ...
        <div className="relative" ref={notificationRef}>
          ...
          >
            <Bell size={20} className="text-primary-saffron" />
            <span className="absolute flex items-center justify-center w-4 h-4 text-xs text-white bg-primary-saffron rounded-full top-0 right-0">
          ...
          {notificationsOpen && (
            <div className="absolute right-0 z-20 mt-2 w-72 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-600">
              ...
              <div className="px-4 py-2 text-center">
                <button className="text-sm text-primary-saffron hover:text-orange-800 dark:text-primary-saffron dark:hover:text-orange-400">
                  View all
                </button>
              </div>
            </div>
        ...
        <div className="relative" ref={userMenuRef}>
          ...
          >
            <div className="flex items-center justify-center w-8 h-8 text-primary-saffron bg-orange-50 rounded-full dark:bg-orange-900 dark:text-primary-saffron">
              <User size={18} />
            </div>
          ...
          {userMenuOpen && (
            <div className="absolute right-0 z-20 w-48 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-600">
              <a href="/profile" className="block px-4 py-2 text-sm text-gray-700 hover:text-primary-saffron hover:bg-gray-100 dark:text-white dark:hover:text-primary-saffron dark:hover:bg-gray-700">
                Profile
              </a>
              <a href="/settings" className="block px-4 py-2 text-sm text-gray-700 hover:text-primary-saffron hover:bg-gray-100 dark:text-white dark:hover:text-primary-saffron dark:hover:bg-gray-700">
                Settings
              </a>
              <button
                onClick={handleLogout}
                className="w-full px-4 py-2 text-sm text-left text-red-600 hover:text-red-700 hover:bg-gray-100 dark:text-red-400 dark:hover:bg-gray-700"
              >
                Logout
              </button>
            </div>
